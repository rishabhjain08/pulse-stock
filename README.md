...
| `SPLITWISE_CONSUMER_KEY` | [secure.splitwise.com/oauth_clients](https://secure.splitwise.com/oauth_clients) | Baked into the APK to construct the OAuth authorize URL; safe to expose |
| `SPLITWISE_CONSUMER_SECRET` | [secure.splitwise.com/oauth_clients](https://secure.splitwise.com/oauth_clients) | Lambda only — never baked into the APK; used server-side for token exchange |
...
| `SPLITWISE_CONSUMER_KEY` | [secure.splitwise.com/oauth_clients](https://secure.splitwise.com/oauth_clients) | Baked into the release build for OAuth authorize URL |
| `SPLITWISE_CONSUMER_SECRET` | [secure.splitwise.com/oauth_clients](https://secure.splitwise.com/oauth_clients) | Lambda only — injected as Lambda env var, never in the APK |
